              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['code'] ?>" class="pull-left"></span>
                    <input type="text" name="information_keyword[<?php echo $language['language_id'] ?>]" value="<?php echo $information_keyword[$language['language_id']]; ?>" placeholder="<?php echo $entry_keyword . ' ' . $language['code']; ?>" id="input-keyword" class="form-control" />
                  </div>
                  <?php if ($error_keyword[$language['language_id']]) { ?>
