              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="category_keyword[<?php echo $language['language_id'] ?>]" value="<?php echo $category_keyword[$language['language_id']]; ?>" placeholder="<?php echo $entry_keyword . ' ' . $language['code']; ?>" id="input-keyword" class="form-control" />
                  </div>
