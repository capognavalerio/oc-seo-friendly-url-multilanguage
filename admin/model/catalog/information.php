...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		...
		if (isset($data['information_keyword'])) {
			foreach ($data['information_keyword'] as $key => $value) {
				if ($value) {
					$this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'information_id=" . (int)$information_id . "', keyword = '" . $this->db->escape($value) . "', language_id = '" . (int)$key . "'");
				}
			}
		}
