...
class ModelCatalogCategory extends Model {
	public function addCategory($data) {
		...
		/**
		 *
		 * Store Multilanguage keyword for SEO Friendly Url
		 * $key is language_id
		 * $value is Seo keyword string
		 *
		 */
		if (isset($data['category_keyword'])) {
			foreach ($data['category_keyword'] as $key => $value) {
				if ($value) {
					$this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'category_id=" . (int)$category_id . "', keyword = '" . $this->db->escape($value) . "', language_id = '" . (int)$key . "'");
				}
			}
		}
	...
	public function editCategory($category_id, $data) {
		...
		/**
		 *
		 * Edit Multilanguage keyword for SEO Friendly Url
		 * $key is language_id
		 * $value is Seo keyword string
		 *
		 */
	...
	public function getCategoryKeywords($category_id) {
		...
		foreach ($query->rows as $result) {
			$category_keyword_data[$result['language_id']] = $result['keyword'];
		}
