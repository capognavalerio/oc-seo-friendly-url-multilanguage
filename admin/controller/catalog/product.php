...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['product_keyword'])) {
			$data['product_keyword'] = $this->request->post['product_keyword'];
		} elseif (isset($this->request->get['product_id'])) {
			$data['product_keyword'] = $this->model_catalog_product->getProductKeywords($this->request->get['product_id']);
		} else {
			$data['product_keyword'] = array();
		}
