...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['category_keyword'])) {
			$data['category_keyword'] = $this->request->post['category_keyword'];
		} elseif (isset($this->request->get['category_id'])) {
			$data['category_keyword'] = $this->model_catalog_category->getCategoryKeywords($this->request->get['category_id']);
		} else {
			$data['category_keyword'] = array();
		}
