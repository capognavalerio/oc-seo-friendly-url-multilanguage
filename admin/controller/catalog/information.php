...
class ControllerCatalogInformation extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['information_keyword'])) {
			$data['information_keyword'] = $this->request->post['information_keyword'];
		} elseif (isset($this->request->get['information_id'])) {
			$data['information_keyword'] = $this->model_catalog_information->getInformationKeywords($this->request->get['information_id']);
		} else {
			$data['information_keyword'] = array();
		}
